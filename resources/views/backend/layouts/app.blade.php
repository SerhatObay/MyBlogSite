...
<head>
    ...
    <link href="{{asset('b_end/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('b_end/img/undraw_profile_1.svg')}}"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('b_end/img/undraw_profile_2.svg')}}"
                                         alt="...">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="{{asset('b_end/img/undraw_profile_3.svg')}}"
                                         alt="...">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="{{asset('b_end/img/undraw_profile.svg')}}">
                        </a>
...
<script src="{{asset('b_end/vendor/jquery/jquery.min.js')}}"></script>
<script src="{{asset('b_end/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

<!-- Core plugin JavaScript-->
<script src="{{asset('b_end/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

<!-- Custom scripts for all pages-->
<script src="{{asset('b_end/js/sb-admin-2.min.js')}}"></script>

<!-- Page level plugins -->
<script src="{{asset('b_end/vendor/chart.js/Chart.min.js')}}"></script>
